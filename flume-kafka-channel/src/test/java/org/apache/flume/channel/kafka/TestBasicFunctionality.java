...
public class TestBasicFunctionality extends TestKafkaChannelBase {
    ...
    public void testDefaultSettingsOnReConfigure() throws Exception {
        ...
        context.put(KafkaChannelConfiguration.KAFKA_PRODUCER_PREFIX + sampleProducerProp, sampleProducerVal);
        context.put(KafkaChannelConfiguration.KAFKA_CONSUMER_PREFIX + sampleConsumerProp, sampleConsumerVal);
    ...
    private void doTestNullKeyNoHeader() throws Exception {
        ...
        ExecutorCompletionService<Void> submitterSvc = new ExecutorCompletionService<>(Executors.newCachedThreadPool());
    ...
    private void doTestStopAndStart(boolean rollback, boolean retryAfterRollback) throws Exception {
        ...
        ExecutorCompletionService<Void> submitterSvc = new ExecutorCompletionService<>(underlying);
